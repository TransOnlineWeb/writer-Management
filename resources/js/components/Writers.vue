...
<template>
    <div class="container">
                            ...
                            <div class="col-md-6" v-for="order in orders" :key="order.id">
                                <div class="info-box">
                                    ...
                                    <div class="info-box-content">
                                      <button class="btn btn-light info-box-number" @click="orderDetails(order)">Order Number: {{ order.order_number }}</button>
                                      <span class="info-box-text">Title: {{ order.title }}</span>
                                      <span class="info-box-text">Deadline: {{ order.deadline }}</span>
        ...
        <div class="modal fade" id="OrderDetails" tabindex="-1" role="dialog" aria-labelledby="AddNewLabel" aria-hidden="true">
                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-header">
                                    <h3 class="card-title">Order Details<span class="badge badge-dark" style="margin-left: 4px;" v-if="details.urgency == 0">Urgent</span></h3>
                                </div>
